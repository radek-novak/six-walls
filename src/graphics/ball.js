...
export default function ballSetup(scene) {
  ...
  sphere.position.y = 0
  sphere.physicsImpostor = new BABYLON.PhysicsImpostor(sphere, BABYLON.PhysicsImpostor.SphereImpostor, { mass: 1, restitution: 1.05, friction: 0.5 }, scene)
  sphere.physicsImpostor.setLinearVelocity(new BABYLON.Vector3(7,5,10))
